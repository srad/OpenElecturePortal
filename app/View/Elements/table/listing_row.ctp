<tr id="list_<?php echo $video['Listing']['id']; ?>" class="">
    ...
    <td><input class="name" type="text" value="<?php echo $video['Listing']['name']; ?>" /></td>
    <td><input class="code" type="text" value="<?php echo $video['Listing']['code']; ?>" /></td>
